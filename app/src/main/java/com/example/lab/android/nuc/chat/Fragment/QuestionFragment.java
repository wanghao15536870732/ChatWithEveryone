...
import com.example.lab.android.nuc.chat.Activity.Question_Add_Activity;
import com.example.lab.android.nuc.chat.Activity.Question_detail_Activity;
                ...
                .execute(new StringCallback() {
                    ...
                    public void onSuccess(Response<String> response) {
                        ...
                        for (int i = 0; i < questiion_list.size(); i++) {
                            ...
                            Question question_1 = new Question(UserInfo.name, R.drawable.picture, str,
